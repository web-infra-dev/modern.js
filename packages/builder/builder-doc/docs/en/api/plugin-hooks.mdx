...
Modify config of webpack or Rspack via the bundler chain api. Similar to webpack chain, this hook is supported to be called when using webpack-provider / rspack-provider.
