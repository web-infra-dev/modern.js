...
```
pnpm add @modern-js/builder-rspack-provider@2.8.0 -D
```
...
This article will introduce the differences between webpack and rspack from the perspective of Builder. If you need to understand more in-depth differences, please refer to the [rspack documentation](http://www.rspack.org/guide/migrate-from-webpack.html).
...
A flexible way for modifying rspack config similar to webpack-chain is not currently available.
