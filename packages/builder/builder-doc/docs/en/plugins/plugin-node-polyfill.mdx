...
:::tip
When using rspack as the bundler,, the Node Polyfill plugin is not supported. It is recommended to use [@rspack/plugin-node-polyfill](https://www.npmjs.com/package/@rspack/plugin-node-polyfill) instead.
:::
