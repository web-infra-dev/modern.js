...
比如在 {MODERN_JS} 框架中，你可以直接在 [modern.config.ts](https://modernjs.dev/docs/apis/app/config/usage) 文件里定义 Builder 的 [source.alias](/api/config-source.html#source-alias) 配置：
