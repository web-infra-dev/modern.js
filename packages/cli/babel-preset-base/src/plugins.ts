...
export const getPluginsChain = (option: IBaseBabelConfigOption) => {
  ...
  chain
    ...
    .use(upath.normalizeSafe(require.resolve('babel-plugin-lodash')), [
      lodashOptions || {},
    ]);
  ...
  chain
    ...
    .use(
      upath.normalizeSafe(require.resolve('@babel/plugin-transform-runtime')),
      [
        {
  ...
  chain
    ...
    .use(
      upath.normalizeSafe(require.resolve('babel-plugin-styled-components')),
      [styledCompontentsOptions || {}, 'styled-components'],
    );
