...
If you have the following plugins (or indirect dependencies) in your project, you need to be temporarily removed or alternative solutions need to be used, otherwise switching to Rspack for building is not supported:
