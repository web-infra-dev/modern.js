...
Builder Rspack build mode comparison [Rspack CLI](https://www.rspack.dev/guide/quick-start.html#using-the-rspack-cli) adds a lot of out-of-the-box capabilities. At the same time, these capabilities will bring a certain degree of performance overhead:

| Features                                  | Description                                                                                                                                                                                                                       | Links                                                                                                                             |
| ----------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| Browser Compatibility                     | Builder will set different default values of Browserslist according to [build target](/guide/basic/build-target)                                                                                                                  | [browserslist](/guide/advanced/browserslist.html)                                                                                 |
| SourceMap generation                      | Builder generates different SourceMaps according to the environment by default                                                                                                                                                    | [output.disableSourceMap](/api/config-output.html#outputdisablesourcemap)                                                         |
| SVG to React component                    | Builder support to import SVG as component by default                                                                                                                                                                             | [Import SVG Assets](/guide/basic/svg-assets.html)<br />[output.disableSvgr](/api/config-output.html#outputdisablesvgr)            |
| Import common component library on demand | When using [Ant Design](https://www.npmjs.com/package/antd) or [Arco Design](https://www.npmjs.com/package/@arco-design/web-react) component library, Builder will automatically enable the on-demand import function by default  | [source.transformImport](/api/config-source#sourcetransformimport)                                                                |
| Type Checker                              | Builder runs TypeScript type checker by default                                                                                                                                                                                   | [Type checking](/guide/basic/typescript.html#类型检查) <br />[output.disableTsChecker](/api/config-output#outputdisabletschecker) |
| PostCSS compilation                       | PostCSS compilation is enabled by default, built-in autoprefixer and other plugins                                                                                                                                                | [Using PostCSS](/guide/basic/css-usage.html#using-postcss)                                                                        |
