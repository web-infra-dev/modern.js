...
| SourceMap generation                      | Builder generates different SourceMaps according to the environment by default                                                                                                                                                   | <ul><li>[output.disableSourceMap](/api/config-output.html#outputdisablesourcemap)</li></ul>                                                           |
...
| Type Checker                              | Builder runs TypeScript type checker by default                                                                                                                                                                                  | <ul><li>[Type checking](/guide/basic/typescript.html#类型检查)</li><li>[output.disableTsChecker](/api/config-output#outputdisabletschecker)</li></ul> |
