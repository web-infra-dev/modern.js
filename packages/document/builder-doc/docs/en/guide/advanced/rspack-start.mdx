...
| @emotion/babel-plugin                           | [builtins.emotion](https://www.rspack.dev/config/builtins.html#builtinsemotion)        | none                                                         |
...
| babel-plugin-lodash                             | none                   | none                                                         |
| babel-plugin-styled-components                  | none                   | none                                                         |
| @babel/plugin-react-transform-remove-prop-types | none                   | none                                                         |
...
Currently, only a limited number of webpack plugins are compatible with Rspack. If the following plugins (or indirect dependencies) are used in your project, they need to be temporarily removed or alternative solutions need to be used, otherwise switching to Rspack for building is not supported:
