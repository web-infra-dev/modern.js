...
We have created a example project based on Vue 2 and Modern.js Builder. You can refer to or directly clone this project and follow the guides in this document for more details.
