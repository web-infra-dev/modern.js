...
| 功能                         | 描述                                                                                                                                                                                  | 相关链接                                                                                                                     |
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| 浏览器兼容性                 | Builder 会根据[构建产物类型](/guide/basic/build-target)来设置不同的 Browserslist 默认值                                                                                               | [浏览器范围](/guide/advanced/browserslist.html)                                                                              |
| SourceMap 生成               | Builder 默认根据环境生成不同的 SourceMap                                                                                                                                              | [output.disableSourceMap](/api/config-output.html#outputdisablesourcemap)                                                    |
| SVG 转 React 组件            | Builder 默认支持在 React 组件中引用 SVG 作为组件                                                                                                                                      | [引用 SVG 资源](/guide/basic/svg-assets.html)<br />[output.disableSvgr](/api/config-output.html#outputdisablesvgr)           |
| 按需引入常用组件库           | 当项目中安装了 [Ant Design](https://www.npmjs.com/package/antd) 或 [Arco Design](https://www.npmjs.com/package/@arco-design/web-react) 组件库时，Builder 会自动添加对应的按需引入能力 | [source.transformImport](/api/config-source#sourcetransformimport)                                                           |
| 默认开启 TypeScript 类型检查 | Builder 会默认通过 TS Checker 检查类型问题                                                                                                                                            | [类型检查](/guide/basic/typescript.html#类型检查) <br />[output.disableTsChecker](/api/config-output#outputdisabletschecker) |
| 默认集成 PostCSS             | Builder 默认集成了 postcss-loader 和一些常用的 poscss 插件                                                                                                                            | [使用 PostCSS](/guide/basic/css-usage.html#使用-postcss)                                                                     |
