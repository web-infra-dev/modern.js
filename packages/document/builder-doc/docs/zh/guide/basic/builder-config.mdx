...
比如在 Modern.js 框架中，你可以直接在 [modern.config.ts](https://modernjs.dev/configure/app/usage.html) 文件里定义 Builder 的 [source.alias](/api/config-source.html#sourcealias) 配置：
