...
近年来，前端工具链的发展趋势是使用 Rust 等编程语言重新实现 —— 以获得更好的性能表现。社区中出现 [SWC](https://swc.rs/)、[Rspack](/guide/glossary.html#rspack) 等高性能工具，并且应用领域在逐步扩宽。但这些 Rust 工具与 JavaScript 工具之间存在较多差异，包括功能不完整、配置不一致等，导致使用者需要承担一定的迁移成本。
...
以拆包场景为例，webpack 原生的 splitChunks 配置较为复杂，Builder 将其封装为开箱即用的 [performance.chunkSplit](/api/config-performance.html#performancechunksplit) 配置项，默认将常见的三方库拆分为体积适中的 chunk，使页面加载速度达到最优状态。
...
| [@modern-js/builder-cli](https://www.npmjs.com/package/@modern-js/builder-cli)                                     | ![](https://img.shields.io/npm/v/@modern-js/builder-cli?style=flat-square)                   | Builder CLI 工具       |
...
| [@modern-js/builder-plugin-vue](https://www.npmjs.com/package/@modern-js/builder-plugin-vue)                       | ![](https://img.shields.io/npm/v/@modern-js/builder-plugin-vue?style=flat-square)            | Vue 3 插件             |
| [@modern-js/builder-plugin-vue2](https://www.npmjs.com/package/@modern-js/builder-plugin-vue2)                     | ![](https://img.shields.io/npm/v/@modern-js/builder-plugin-vue2?style=flat-square)           | Vue 2 插件             |
...
| [@modern-js/builder-doc](https://www.npmjs.com/package/@modern-js/builder-doc)                                     | ![](https://img.shields.io/npm/v/@modern-js/builder-doc?style=flat-square)                   | Builder 文档           |

你可以在 modern.js 仓库的 [packages/builder](https://github.com/web-infra-dev/modern.js/tree/main/packages/builder/) 目录下查看这些包的源代码。
