...
:::tip
If you want to develop a custom theme from scratch, you can go to [Redevelop a custom theme](/advanced/custom-theme#redevelop-a-custom-theme).
:::
...
Of course, you may need to use page data during the development process, you can get it through the Hook [`usePageData`](/api/api-runtime#usepagedata).
