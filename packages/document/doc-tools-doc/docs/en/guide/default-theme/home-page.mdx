...
You can define the content of the Home page through frontmatter, see [FrontMatter Config](/api/config-frontmatter.html#hero) for detailed types. Here is a simple example:
