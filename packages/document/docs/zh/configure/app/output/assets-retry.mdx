...
`assetsRetry` 是基于 Rsbuild 的 Assets Retry 插件实现的，并提供相同的配置项。你可以参考 [Rsbuild - Assets Retry 插件](https://github.com/rstackjs/rsbuild-plugin-assets-retry) 来了解所有可用的配置项。
