...
:::warning
**Deprecated**：该配置已废弃，请使用 [dev.server.compress](https://modernjs.dev/configure/app/dev/server) 代替。
:::
...
:::warning
**Deprecated**：该配置已废弃，请使用 [dev.server.headers](https://modernjs.dev/configure/app/dev/server) 代替。
:::
...
:::warning
**Deprecated**：该配置已废弃，请使用 [dev.server.historyApiFallback](https://modernjs.dev/configure/app/dev/server) 代替。
:::
...
:::warning
**Deprecated**：该配置已废弃，请使用 [dev.server.proxy](https://modernjs.dev/configure/app/dev/server) 代替。
:::
...
:::warning
**Deprecated**：该配置已废弃，请使用 [dev.server.watch](https://modernjs.dev/configure/app/dev/server) 代替。
:::
