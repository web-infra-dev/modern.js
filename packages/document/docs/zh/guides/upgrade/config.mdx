...
**变更内容**: V3 新增配置，用于开启跨项目调用 BFF 功能，具体请参考 [BFF 跨项目调用](/guides/advanced-features/bff/cross-project)。
...
**变更内容**: 该配置已废弃，请参考 [Rsdoctor 文档](/guides/basic-features/debug/rsdoctor)，使用 Rspack 的 [Rsdoctor 插件]来启用支持。
