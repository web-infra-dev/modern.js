...
When using the [loader](/guides/basic-features/data-fetch#loader-函数) function to obtain data, `params` will be passed as an input parameter to the `loader` function, and the corresponding parameter can be obtained through the attribute of `params`.
