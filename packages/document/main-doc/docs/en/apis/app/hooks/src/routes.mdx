...
React Router v7 has very few breaking changes compared to React Router v6, and Modern.js is compatible with both versions. You can upgrade seamlessly by simply installing and registering the appropriate plugin in your project.
...
React Router v7 has also deprecated the `json` API; you can use `Response.json` instead:
