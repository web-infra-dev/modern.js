...
```tsx
import { useRuntimeContext } from '@edenx/runtime';
...
The information contained in the context includes:
...
<Tabs
  defaultValue="SSRContext"
  values={[
    { label: 'SSRContext', value: 'SSRContext', },
    { label: 'ServerContext', value: 'ServerContext', },
    { label: 'ClientContext', value: 'ClientContext', },
  ]
}>
<TabItem value="SSRContext">

```ts
type SSRContext = ServerContext | ClientContext;
```
