...
:::warning
We recommend organizing your code using the directory conventions provided by Modern.js to better utilize framework functionality and avoid some redundant configuration.
