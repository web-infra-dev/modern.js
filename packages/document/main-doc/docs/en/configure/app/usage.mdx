...
When using Rspack as the bundler, due to some differences in configuration types between webpack and Rspack, you need to specify the `` generic for `defineConfig`:
