...
Modern.js BFF supports different runtime frameworks. Currently, Modern.js BFF integrates the [Hono.js](https://hono.dev/) runtime framework by default, and supports registration of two runtime frameworks: [Express.js](https://expressjs.com/) and [Koa.js](https://koajs.com/).
...
<TabItem value="express" label="Hono.js" default>
