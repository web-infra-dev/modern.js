...
If you need to customize the HTML template, please refer to [HTML template](https://modernjs.dev/guides/basic-features/html.html). Manually modifying the template through html.template / tools.html will cause this feature not work.
:::
