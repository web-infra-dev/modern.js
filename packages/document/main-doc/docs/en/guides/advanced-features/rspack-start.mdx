...
If you need to use the nightly/canary version of Rspack, which is shipped to the package name with the `-canary` suffix added, you need to override all Rspack internal packages:
