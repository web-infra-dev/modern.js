...
For example, if you are using pnpm, you can override the Rspack version with `overrides` as shown below:
...
If you need to use the nightly/canary version of Rspack, the package name of the nightly/canary version of Rspack will be released after adding the `-canary` suffix, and all Rspack internal packages need to be overrided:
...
```json title=package.json
{
  "pnpm": {
    "overrides": {
      ...
      "@rspack/binding-darwin-arm64": "npm:@rspack/binding-darwin-arm64-canary@nightly",
      "@rspack/binding-darwin-x64": "npm:@rspack/binding-darwin-x64-canary@nightly",
      "@rspack/binding-linux-x64-gnu": "npm:@rspack/binding-linux-x64-gnu-canary@nightly",
      "@rspack/binding-win32-x64-msvc": "npm:@rspack/binding-win32-x64-msvc-canary@nightly",
      "create-rspack": "npm:create-rspack-canary@nightly",
      "@rspack/core": "npm:@rspack/core-canary@nightly",
      "@rspack/cli": "npm:@rspack/cli-canary@nightly",
      "@rspack/dev-server": "npm:@rspack/dev-server-canary@nightly",
      "@rspack/plugin-minify": "npm:@rspack/plugin-minify-canary@nightly",
      "@rspack/plugin-react-refresh": "npm:@rspack/plugin-react-refresh-canary@nightly",
      "@rspack/plugin-preact-refresh": "npm:@rspack/plugin-preact-refresh-canary@nightly",
      "@rspack/test-tools": "npm:@rspack/test-tools-canary@nightly"
    },
    "peerDependencyRules": {
      "allowAny": [
        "@rspack/*"
