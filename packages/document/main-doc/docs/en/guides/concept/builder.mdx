...
Modern.js Builder is based on [Rsbuild](https://rsbuild.dev/). Rsbuild is one of the core components of the Modern.js system. It is a build tool for web development scenarios that can be used independently of Modern.js.
