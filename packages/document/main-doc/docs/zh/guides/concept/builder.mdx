...
Modern.js Builder 基于 [Rsbuild](https://rsbuild.dev/) 封装。Rsbuild 是 Modern.js 体系的核心组件之一，它是一个基于 Rspack 的 Web 构建工具，可以脱离 Modern.js 被独立使用。
...
Rsbuild 是一个可独立使用的模块，拥有单独的文档，文档地址为：[Rsbuild](https://rsbuild.dev/)。
