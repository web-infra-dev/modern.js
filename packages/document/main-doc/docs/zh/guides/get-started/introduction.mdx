...
- 如果你需要基于 Modern.js 的构建引擎来实现一个 Web 开发框架，请移步 [Modern.js Builder](https://modernjs.dev/builder) 文档。
...
- 如果你需要引入微前端架构，推荐使用 [Garfish](https://garfish.bytedance.net/)。
