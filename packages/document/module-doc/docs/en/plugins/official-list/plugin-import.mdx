...
:::tip
Since `@modern-js/module-tools` version >= v2.16.0, this plugin functionality is built into Modern.js Module and is provided by [`transformImport`](api/config/build-config.html#transformimport).
:::
