...
** By default, the name of the source file is used as the name of the module's global variable in the browser. **For the above example, the output code would read as follows:
...
The build artifacts at this point are:
