...
import type { RuntimePluginConfig } from '../../types';
import {
...
const genRenderCode = ({
  ...
  return `import { createRoot } from '@${metaName}/app-tools/runtime/react';
import { render } from '@${metaName}/app-tools/runtime/browser';

${
  enableRsc
    ? `import { RscClientRoot, createFromReadableStream, rscStream, callServer } from '@${metaName}/app-tools/runtime/rsc/client';`
    : ''
}
...
export const entryForCSRWithRSC = ({
  ...
  import { render } from '@${metaName}/app-tools/runtime/browser';
  import { createRoot } from '@${metaName}/app-tools/runtime/react';

  import {
    RscClientRoot,
    createFromFetch
  } from '@${metaName}/app-tools/runtime/rsc/client';
...
}) => `import { registerPlugin, mergeConfig } from '@${metaName}/app-tools/runtime/plugin';
import { getGlobalAppConfig, getGlobalLayoutApp, getCurrentEntryName } from '@${metaName}/app-tools/runtime/context';
...
export const runtimeGlobalContext = ({
  ...
  return `import { setGlobalContext } from '@${metaName}/app-tools/runtime/context'
...
export const runtimeGlobalContextForRSCServer = ({
  ...
  import { setGlobalContext } from '@${metaName}/app-tools/runtime/context';
