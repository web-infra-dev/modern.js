...
[Rspack](https://www.rspack.org/) is a Rust Bundler developed by the ByteDance Web Infra team. The core architecture of Rspack is aligned with the implementation of webpack, and provides out-of-the-box support for commonly used build features.
...
The Modern.js generator provides an interactive question-and-answer interface to initialize a project based on the results. To create an rspack project, simply select the **rspack** build tool by running:
