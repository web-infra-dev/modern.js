...
export const PLUGIN_SCHEMAS = {
  ...
  '@modern-js/plugin-design-token': [
    {
      target: 'source.designToken',
      schema: {
        type: 'object',
        properties: {
          // Controls whether designTokens is active for JS API
          js: {
            type: ['boolean'],
            default: true,
          },
          // Controls whether designTokens is active for styled-components
          styledComponents: {
            type: ['boolean'],
            default: true,
          },
          // Controls whether designTokens is active for css
          css: {
            type: ['boolean'],
            default: true,
          },
          // Controls whether designTokens is active for less
          less: {
            type: ['boolean'],
            default: true,
          },
          // Controls whether designTokens is active for sass
          sass: {
            type: ['boolean'],
            default: true,
          },
          // Whether to use the default theme generated by designTokens
          defaultTheme: {
            type: ['boolean'],
            default: true,
          },
          // Controls whether designTokens is active for tailwindcss.
          // when is true, tools.tailwindcss.theme and source.theme cannot exist at the same time
          tailwindcss: {
            type: ['boolean'],
            default: true,
          },
    ...
    {
      target: 'source.theme',
      schema: { type: ['object', 'boolean'], default: false },
    },
    // Legacy Features
    {
