...
test('should inline style when disableCssExtract is false', async ({
  ...
  expect(
    files[mainJsFile].includes(
      'body,html{margin:0;padding:0}*{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;-moz-box-sizing:border-box;box-sizing:border-box}.description{font-size:16px;line-height:1.5;text-align:center}',
    ),
  ).toBeTruthy();
