...
| 文件别名        | 可选功能，通过 alias 设置文件别名                                                     | <ul><li>[路径别名](/guide/basic/alias.html)</li><li>[source.alias](/zh/api/config-source.html#source-alias)</li></ul>                                                                                                |
...
| 功能                | 描述                                                           | 相关链接                                                                                                                                                    |
| ------------------- | -------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 产物自动拆包        | Builder 中内置了多种拆包策略，自动将代码包拆分为体积适中的文件 | <ul><li>[拆包最佳实践](/guide/advanced/split-chunk.html)</li><li>[performance.chunkSplit](/zh/api/config-performance.html#performance-chunksplit)</li></ul> |
